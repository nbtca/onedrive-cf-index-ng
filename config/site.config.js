...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'contact@nbtca.space',
  ...
  protectedRoutes: ['/NBTCA'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:contact@nbtca.space',
